...
static int ng_tcp_enqueue_ackpkt(struct ng_tcp_stream *stream, struct rte_tcp_hdr *tcphdr)
{
...
static int ng_tcp_enqueue_pkt(struct ng_tcp_stream *stream, struct rte_tcp_hdr *tcphdr, int tcplen)
{
